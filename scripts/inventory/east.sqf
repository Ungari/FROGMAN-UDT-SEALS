...
for "_i" from 1 to 2 do {(_this select 0) addItemToUniform "FirstAidKit";};
for "_i" from 1 to 5 do {(_this select 0) addItemToUniform "20Rnd_556x45_UW_mag";};
for "_i" from 1 to 4 do {(_this select 0) addItemToUniform "11Rnd_45ACP_Mag";};
(_this select 0) addVest "V_RebreatherIR";
...
(_this select 0) addGoggles "G_O_Diving";
